...
export function Header() {
	return (
      ...
      flex items-center justify-between relative z-10"
			>
				<div className="hidden 2xl:block absolute size-2 border left-0 bottom-0 rotate-45 -translate-x-1/2 translate-y-1/2 bg-white border-neutral-300" />
				<div className="hidden 2xl:block absolute size-2 border right-0 bottom-0 rotate-45 translate-x-1/2 translate-y-1/2 bg-white border-neutral-300" />
